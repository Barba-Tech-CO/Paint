...
class AuthService {
  ...
  Future<Result<AuthStatusResponseEntity>> getStatus() async {
    try {
      final response = await _httpService.get('/auth/status');
      final authStatus = AuthStatusResponseEntity.fromJson(response.data);
  ...
  Future<Result<AuthRefreshResponseEntity>> processCallback(String code) async {
    try {
      final response = await _httpService.get('/auth/callback?code=$code');
      final callbackResponse = AuthRefreshResponseEntity.fromJson(
        response.data,
      );
  ...
  Future<Result<AuthRefreshResponseEntity>> refreshToken() async {
    try {
      final response = await _httpService.post(
        '/auth/refresh',
        data: {},
      );
      final refreshResponse = AuthRefreshResponseEntity.fromJson(response.data);
