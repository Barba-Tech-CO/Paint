...
import '../../domain/usecases/handle_webview_navigation_usecase.dart';
...
class AuthViewModel extends ChangeNotifier {
  ...
  late final Command0<AuthEntity> checkAuthStatusCommand = Command0(
    _checkAuthStatus,
  );
  ...
  Future<Result<AuthEntity>> _checkAuthStatus() async {
